...
export default async function RoadworthyPage() {
  const { options, truckTypes, trailerTypes, leadDays, days } = await getRwcBookingOptions();
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-7">
              <div className="relative border border-line-soft bg-ink-2 p-6 sm:p-8">
                <RoadworthyBookingForm options={options} truckTypes={truckTypes} trailerTypes={trailerTypes} minDate={minDate} openDaysLabel={openDaysLabel} />
              </div>
            </div>
          </div>
        </Container>
